...
public class PokeNearbySQLiteHelper extends SQLiteOpenHelper {

    public static final String TABLE_POKENEARBY = "nearby";
    ...
    public PokeNearbySQLiteHelper(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_POKENEARBY);
        onCreate(db);
    }
